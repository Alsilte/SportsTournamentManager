<template>
  <MainLayout>
    <template #header>
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div class="flex items-center space-x-4">
          ...
          <div>
            <h1 class="text-3xl font-bold text-gray-900">{{ player?.user?.name || 'Perfil del Jugador' }}</h1>
    ...
    <div v-else-if="player" class="space-y-8">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="card p-6">
              ...
              <div class="flex-1">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div v-if="player.preferred_foot" class="flex items-center text-gray-600">
                    ...
                    <span class="capitalize">{{ player.preferred_foot }} pie preferido</span>
                  </div>
            ...
            <div v-if="player.biography" class="pt-6 border-t border-gray-200">
              <h3 class="text-lg font-semibold text-gray-900 mb-3">Acerca de</h3>
          ...
          <!-- Current Teams -->
          <div class="card p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Equipos Actuales</h3>
        ...
        <div class="space-y-6">
          ...
          <div class="card p-6">
            ...
            <div class="space-y-4">
              ...
              <div class="text-center p-4 bg-success-50 rounded-lg">
                ...
                <div class="text-sm text-gray-600">Goles anotados</div>
              </div>
          ...
          <div class="card p-6">
            <h3 class="text-lg font-semibold text-gray-900 mb-4">Logros</h3>
            <div class="space-y-3">
              <div 
              ...
              >
                ...
                <div>
                  <div class="font-medium text-primary-900">Goleador</div>
                  <div class="text-sm text-primary-700">{{ playerStats.goals }} goles</div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <div class="font-medium text-warning-900">Capitán de equipo</div>
                  <div class="text-sm text-warning-700">Rol de liderazgo</div>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <div class="font-medium text-success-900">Jugador experimentado</div>
                  <div class="text-sm text-success-700">{{ playerStats.total_matches }}+ partidos</div>
                </div>
              </div>

              <div v-if="!hasAnyAchievements" class="text-center py-4 text-gray-500">
                <TrophyIcon class="w-8 h-8 mx-auto mb-2 text-gray-300" />
                <p class="text-sm">Aún no hay logros</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="min-h-[300px]">
        ...
        <div v-if="activeTab === 'matches'" class="space-y-4">
          ...
          <div class="text-center py-12 text-gray-500">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">Historial de partidos</h3>
            <p>Esta función estará disponible cuando se desarrolle el endpoint correspondiente</p>
            <p class="text-sm text-gray-400 mt-2">
              Endpoint necesario: <code class="bg-gray-100 px-2 py-1 rounded">GET /api/players/{id}/matches</code>
            </p>
          </div>
        </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="card p-6">
              ...
              <div class="space-y-4">
                ...
                <div class="flex justify-between items-center">
                  <span class="text-gray-600">Tarjetas por partido</span>
                  <span class="font-medium">{{ cardsPerMatch }}</span>
                </div>
                <div class="flex justify-between items-center">
                  <span class="text-gray-600">Equipos activos</span>
            ...
            <!-- Team History -->
            <div class="card p-6">
              <h3 class="text-lg font-semibold text-gray-900 mb-4">Información de carrera</h3>
              <div class="space-y-3">
                <div v-if="player.user?.created_at" class="flex justify-between items-center">
                  <span class="text-gray-600">Se unió a la plataforma</span>
                ...
                <div class="text-center py-4 text-gray-500">
                  <p class="text-sm">Las estadísticas de carrera están disponibles cuando hay datos suficientes</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div v-else-if="error" class="text-center py-12">
      ...
      <h3 class="text-lg font-medium text-gray-900 mb-2">Jugador no encontrado</h3>
...
export default {
  ...
  setup() {
    ...
    const tabs = [
      { id: 'matches', name: 'Historial de partidos' },
